...
const BlogDetail = () => {
    return (
        <>
            <Breadcrumb title="Blog Details" content="Discover the most recent blogs about artificial intelligence here." image="blog-details-vector.svg" />

            <section className="ratio_40">
                <div className="container">
                    <div className="blog-details">
                        <div className="blog-img">
                            <img src="/assets/images/blog/7.jpg" className="img-fluid w-100 bg-img" alt="blog" />
                        </div>
                        <div className="blog-title-box">
                            <a data-cursor="pointer" className="main-title" href="blog-details.html">Leading 6 Modern
                                Content Marketing Trends
                                for 2023</a>
                            <ul>
                                <li><img src="/assets/images/user/2.jpg" className="img-fluid avtar" alt="author" /> Smith John
                                </li>
                                <li><i className="iconsax" data-icon="calendar-add"></i> 14 march 2023</li>
                                <li><i className="iconsax" data-icon="clock"></i> 5 min</li>
                            </ul>
                        </div>
                        <div className="row">
                            <div className="col-lg-8 col-md-10 m-auto">
                                <div className="blog-main-content">
                                    <h3><img src="/assets/svg/title-effect2.svg" className="img-fluid" alt="effect" />OVERVIEW</h3>
                                    ...
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />how
                                        I manage
                                        video content</h3>
                                    ...
                                    <img src="/assets/images/blog/8.jpg" className="img-fluid rounded-3 my-4" alt="blog" />
                                    <h3 className="mt-xl-5 mt-md-3 mt-2"><img src="/assets/svg/title-effect2.svg"
                                        className="img-fluid" alt="effect" />Live
                                        Streaming</h3>
            ...
            <section className="comment-section pb-md-5 pb-0">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-md-10 m-auto">
                                    ...
                                    <ul>
                                        <li>
                                            <div className="user-box border-color">
                                                <div className="reply-button">
                                                    <span className="text-theme-color">Reply</span>
                                                </div>
                                                <div className="user-image">
                                                    <img src="../assets/images/user/1.jpg" className="img-fluid" alt="" />
                                                    <div className="user-name">
                                                        <h6>30 Jan, 2022</h6>
                                                        <h5 className="text-title">Glenn Greer</h5>
                                                    </div>
                                                </div>
                                        ...
                                        <li>
                                            <div className="user-box border-color">
                                                ...
                                                <div className="user-image">
                                                    <img src="../assets/images/user/2.jpg" className="img-fluid" alt="" />
                                                    <div className="user-name">
                                                        <h6>30 Jan, 2022</h6>
                                                        <h5 className="text-title">Glenn Greer</h5>
                                                    </div>
                                        ...
                                        <li className="li-padding">
                                            <div className="user-box">
                                                ...
                                                <div className="user-image">
                                                    <img src="../assets/images/user/3.jpg" className="img-fluid" alt="" />
                                                    <div className="user-name">
                                                        <h6>30 Jan, 2022</h6>
                                                        <h5 className="text-title">Glenn Greer</h5>
                                                    </div>
                            ...
                            <div className="leave-box mt-4">
                                <div className="leave-comment">
                                    <div className="comment-notes">
                                        <h3 className="text-title mb-2">Leave Comment</h3>
                                        <p className="text-content mb-4">Your email address will not be published. Required
                                            fields
                                            are marked</p>
                                    </div>
                                    <form className="auth-form">
                                        ...
                                        <button className="btn btn-solid ms-xxl-auto mt-sm-5 mt-4">Post
                                            Comment</button>
                                    </form>
                                </div>
                            </div>
